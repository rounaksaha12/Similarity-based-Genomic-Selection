...
if __name__ == '__main__':
	...
	with open(f'results/feature_sel/{args.dataset}/{args.trait}/obscured/seeds/obscured_seed_{args.seed}.csv','w') as f:
	...
	for k_feat in k_feats:
		...
		# plt.close()
		with open(f'results/feature_sel/{args.dataset}/{args.trait}/obscured/seeds/obscured_seed_{args.seed}.csv','a') as f:
	...
	# plt.savefig(f'results/feature_sel/{args.dataset}/{args.trait}/seed/obscured/inflection_plot.pdf')