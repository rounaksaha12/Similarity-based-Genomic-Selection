...
if __name__ == '__main__':
	...
	with open(f'results/feature_sel/{args.dataset}/{args.trait}/deepgs/deepgs.csv','w') as f:
	...
	for k_feat in k_feats:
		...
		plt.close()
		with open(f'results/feature_sel/{args.dataset}/{args.trait}/deepgs/deepgs.csv','a') as f:
